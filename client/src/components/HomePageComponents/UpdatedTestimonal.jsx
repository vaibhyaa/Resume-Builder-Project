  ...
  const cardsData = [
    {
      ...
      handle: "@neilstellar",
      date: "April 20, 2025",
      comments: "Loving the new UI design updates! Everything feels smoother.",
    },
    {
      image:
      ...
      handle: "@averywrites",
      date: "May 10, 2025",
      comments: "This project is shaping up amazingly. Great work team!",
    },
    {
      image:
      ...
      handle: "@jordantalks",
      date: "June 5, 2025",
      comments: "Had a productive day learning React hooks today!",
    },
    {
      image:
      ...
      handle: "@averywrites",
      date: "May 10, 2025",
      comments: "Excited about the new features launching this week!",
    },
  ];
      ...
      <>
        ...
        <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
          ...
          <div className="marquee-inner marquee-reverse flex transform-gpu min-w-[200%] pt-10 pb-5">
            {/*
			...cardsData = spread array
[...cardsData, ...cardsData] = combine array twice
.map() = loop through and return component for each card
( ) = implicit return of JSX 
			 */}
            {[...cardsData, ...cardsData].map((card, index) => (
              <CreateCard key={index} card={card} />
            ))}
...
export default UpdatedTestimonal;
